...
import com.ccx.helloworld.springcloud.config.feign.time.ServiceFeignConfiguration;
...
@FeignClient(contextId = "test"
			,name="${ccx.springcloud.application.name.pccredit}"
