...
public class RedisEhcacheCache extends AbstractValueAdaptingCache {
	...
	private final Logger logger = LoggerFactory.getLogger(RedisEhcacheCache.class);
	...
	public RedisEhcacheCache(String name, RedisTemplate<Object, Object> stringKeyRedisTemplate,
			Cache<Object, Object> ehcacheCache, RedisEhcacheConfigProperties cacheRedisCaffeineProperties) {
